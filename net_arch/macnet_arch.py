...
from .macnet.utils import est_noise,count
# from model.qrnn.combinations import *
from .macnet.non_local import NLBlockND,EfficientNL
from .qrnn3d_utils.combinations import *
...
class MACNet(nn.Module):
    ...
    def pro_sub(self, I):
        ...
        for _I in I:
            ...
            I_nlm = _I.cpu().numpy()
            sigma_est = estimate_sigma(I_nlm, average_sigmas=True)
            I_nlm = denoise_nl_means(I_nlm, patch_size=7, patch_distance=9, h=0.08,
