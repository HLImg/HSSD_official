...
class CATransBlock(nn.Module):
    ...
    def forward(self, x):
        ...
        trans_x_end = rearrange(trans_x, 'b h w c -> b c h w')
        
        res = self.conv_tail(trans_x_end)
