# -*- encoding: utf-8 -*-
# @Author  :   Liang Hao 
# @Time    :   2023/10/30 14:03:00
# @File    :   test_realistic.py
...
from dataset import SERTDataSetMixNew
...
def test(net, name, path, device, args):
    ...
    dataset = SERTDataSetMixNew(path['hq'], path['lq'], scale=1, patch_size=-1, 
                             flip=False, rotation=False, norm=False, noise_clip=True)
    num = dataset.__len__()
...
if __name__ == '__main__':
    test_dataset = {
       'realistic':{
            'hq': '/home/lianghao/data/realistic/test_hq.lmdb',
            'lq': '/home/lianghao/data/realistic/test_lq.lmdb'
        }
    }
